...
assert.strictEqual(logic.isAtEnd(1498, 1000, 2500), true)
assert.strictEqual(logic.isAtEnd(1420, 1000, 2500), true)
assert.strictEqual(logic.isAtEnd(1403, 1000, 2500), false)
